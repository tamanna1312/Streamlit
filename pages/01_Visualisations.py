...
if sel_vis == 'map':
	if st.session_state.all_data is None:
		...
		map = folium.Map(location=[34, 100], zoom_start=5, control_scale=True, tiles='https://server.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer/tile/{z}/{y}/{x}', 
